...
var ASM_CONSTS = {
  3649472: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3649527: function($0) {performance.now = function() { return $0; };},  
 3649575: function($0) {performance.now = function() { return $0; };},  
 3649623: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3649678: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3649739: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3649803: function() {return Module.webglContextAttributes.powerPreference;}
};
